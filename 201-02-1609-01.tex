...
\begin{solution}3.
	...
	Assume \( U \) is \( d_{\infty} \)-open. i.e. \( \exists \ \epsilon_{\infty} \text{ s.t. } B_{\epsilon_{\infty}}(x_{0},y_{0}) \subset U\)
	...
	\]
	\[
		B_{\epsilon_{1}}^{d_1}(x_{0},y_{0}) \left\{ (x,y) \in X\times Y \mid d_X(x,x_{0}) + d_Y(y,y_{0}) < \epsilon_{1} = \epsilon_{\infty} \right\}
	\]
	If \( a \in B_{\epsilon_{1}}^{d_1} \Rightarrow a \in B_{\epsilon_{\infty}}^{d_{\infty}} \) since \( d_{\infty} \le d_1 \) (from part above) \( \Rightarrow B_{\epsilon_{1}}^{d_{1}} \subset B_{\epsilon_{\infty}}^{d_{\infty}} \subset U  \).

	Hence \( U \) is \( d_{1} \)-open
	\\

	Assume \( U \) is \( d_{1} \)-open. i.e. \( \exists \ \epsilon_1 \text{ s.t. } B_{\epsilon_{1}} \subset U \)

	Choose \( \epsilon_2 = \epsilon_{1} \)
